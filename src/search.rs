...
const SEARCH_URL: &str = "https://www.mojiodpadki.si/api2/";
...
fn get_street_search_url_and_request(term: Option<&str>) -> (String, String) {
...
fn get_address_search_url_and_request(street_id: u32) -> (String, String) {
